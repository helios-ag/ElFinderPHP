...
use Dropbox_OAuth_Curl;
use Dropbox_OAuth_PEAR;
use Dropbox_OAuth_PHP;
...
class ElFinderVolumeDropbox extends ElFinderVolumeDriver {
     ...
     *
     * @return \FM\ElFinderPHP\Driver\ElFinderVolumeDropbox
     * @author Dmitry (dio) Levashov
     * @author Cem (DiscoFever)
     */
...
//ini_set('memory_limit', '128M');
        ...
        $opts = array(
            ...
            'root' => 'Dropbox',
            'path' => '/',
            'PDO_DSN' => 'mysql:host=localhost', // if empty use 'sqlite:(metaCachePath|tmbPath)/elFinder_dropbox_db_(hash:dropboxUid+consumerSecret)'
            'PDO_User' => 'root',
            'PDO_Pass' => '12345',
            'PDO_Options' => array(),
            'PDO_DBName' => 'dropbox',
...
//            'driver'     => 'Dropbox',
//            'path'       => '/',
//            'consumerKey'       => 'i17rqbegp1b6p1u',
//            'consumerSecret'    => 'adg187ke7ohmri0',
//            'accessToken'       => '8xfw37oa99knp02e',
//            'accessTokenSecret' => '9qyaouie5o08erl',
//            'dropboxUid'        => '4468019',
//            'alias'      => 'Dropbox.com',
//            'mimeDetect' => 'internal',
//            'tmbURL'     => dirname($_SERVER['PHP_SELF']) . '/files/.tmb',
//            'tmbPath'    => dirname(dirname(__FILE__)) . '/files/.tmb',
//            'utf8fix'    => true,
//            'tmbCrop'    => false,
//            'separator' => '/',
...
//        var_dump($options['consumerSecret']);
...
//        if (!$this->metaCache) {
//            return $this->setError('Cache directory (metaCachePath or tmp) is required');
//        }
